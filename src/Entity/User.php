...
class User implements UserInterface
{
    ...
    // getSalt renvoie la chaine de caractère saisie par l'utilisateur et non encodée qu'il renvoie à l'encoder pour qu'il procède au hashage du mot de pass
    ...
    // cette méthode vise à nettoyer les mdp en texte brut (non hashé) éventuellemment stockés en BDD

<?php namespace App\Service\Panier;
...
class PanierService{
    ...
    {
        /**
         * on supprime la ligne d'article si un seul en quantité, sion on décrémente la quantité d'articles
         *
         */
        $panier=$this->session->get('panier', []);
    ...
    {
        /**
         *ici on vide totalement la ligne d'articles peu importe la quantité
         *
         */
        $panier=$this->session->get('panier', []);
    ...
    {
     /**
      * on fait une boucle permettant de sythétiser les ajouts effectués par article avec la quantité correspondante
      */
